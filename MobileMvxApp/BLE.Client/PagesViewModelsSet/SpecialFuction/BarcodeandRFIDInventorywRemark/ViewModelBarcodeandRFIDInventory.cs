...
{
    public class ViewModelBarcodeandRFIDInventorywRemark : BaseViewModel
    {
        public class BarcodeandRFIDTagInfoViewModel : BindableBase
        {
            ...
            public string REMARK { get { return this._REMARK; } set { this.SetProperty(ref this._REMARK, value); } }
        ...
        public ViewModelBarcodeandRFIDInventorywRemark(IAdapter adapter, IUserDialogs userDialogs/* , IPermissions permissions */) : base(adapter)
        {
        ...
        ~ViewModelBarcodeandRFIDInventorywRemark()
        {
        }
