    ...
    public class ViewModelRFMicroS2Inventory : BaseViewModel
    {
        ...
        void InventorySetting()
        {
            ...
            // Select RFMicro S2 filter
            {
                ...
                extraSlecetion.mask = new CSLibrary.Structures.SelectMask(CSLibrary.Constants.MemoryBank.BANK3, 0xa0, 8, new byte[] { 02 });
                ...
                extraSlecetion.mask = new CSLibrary.Structures.SelectMask(CSLibrary.Constants.MemoryBank.EPC, 0, 0, new byte[] { 0x00 });
